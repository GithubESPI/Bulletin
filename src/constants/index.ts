...
export const stepsData = [
  ...
  },
  {
    ...
    description:
      "Cliquez sur le bouton Générer vos bulletins pour lancer le processus. Déposez votre document Word et Excel, puis le système va automatiquement traiter les fichiers Excel et Word pour créer des bulletins de notes au format PDF.",
